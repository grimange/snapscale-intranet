  ...
  $(
    '<div class="customizer-links">' +
      '<div class="nav flex-column nac-pills" id="c-pills-tab" role="tablist" aria-orientation="vertical">' +
        ...
        '</a>' +
        // '<a class="nav-link" target="_blank" href="https://docs.pixelstrap.com/cuba/django/document/" target="_blank" data-original-title="">' +
    ...
    '<div class="customizer-contain">' +
      '<div class="tab-content" id="c-pills-tabContent">' +
        '<div class="customizer-header">' +
          ...
          '<p class="mb-0">Try It Real Time<i class="fa-regular fa-thumbs-up txt-primary fa-fade"></i></p>' +
        '</div>' +
        ...
        '<div class="tab-pane fade" id="c-pills-home" role="tabpanel" aria-labelledby="c-pills-home-tab">' +
            ...
            '<h6>Unlimited Color</h6>' +
              '<ul class="layout-grid unlimited-color-layout">' +
                ...
                '<input id="ColorPicker2" type="color" value="#838383" name="Background">' +
            ...
            '<h6>Light layout</h6>' +
              '<ul class="layout-grid customizer-color">' +
                '<li class="color-layout" data-attr="color-1" data-primary="#7366ff" data-secondary="#838383">' +
                  '<div></div>' +
                '</li>' +
          ...
          '<ul class="sidebar-type layout-grid layout-types">' +
            '<li data-attr="compact-sidebar">' +
              '<div class="layout-img">' +
                '<a href="javascript:void(0)"><img src="/static/assets/images/landing/layout-images/dubai.jpg" class="img-fluid" alt=""></a>' +
                '<h6>Dubai</h6>' +
              '</div>' +
            '</li>' +
            '<li data-attr="material-layout">' +
              '<div class="layout-img"><a href="javascript:void(0)">' +
                '<img src="/static/assets/images/landing/layout-images/los-angle.png" class="img-fluid" alt=""></a>' +
                '<h6>Los Angeles</h6>' +
              '</div>' +
            '</li>' +
            '<li data-attr="dark-sidebar">' +
              '<div class="layout-img">' +
                  '<a href="javascript:void(0)">' +
                    '<img src=/static/assets/images/landing/layout-images/paris.jpg class="img-fluid" alt="">' +
                  '</a>' +
                  '<h6>Paris</h6>' +
              '</div>' +
            '</li>' +
            '<li data-attr="compact-wrap">' +
              '<div class="layout-img">' +
                '<a href="javascript:void(0)">' +
                  '<img src="/static/assets/images/landing/layout-images/tokyo.jpg" class="img-fluid" alt="">' +
                '</a>' +
                '<h6>Tokyo</h6>' +
              '</div>' +
            '</li>' +
            '<li data-attr="compact-small">' +
              '<div class="layout-img">' +
                  '<a href="javascript:void(0)">' +
                    '<img src="/static/assets/images/landing/layout-images/moscow.jpg" class="img-fluid" alt="">' +
                  '</a>' +
                  '<h6>Moscow</h6>' +
              '</div>' +
            '</li>' +
            '<li data-attr="enterprice-type">' +
              '<div class="layout-img">' +
                '<a href="javascript:void(0)">' +
                  '<img src="/static/assets/images/landing/layout-images/singapore.jpg" class="img-fluid" alt="">' +
                '</a>' +
                '<h6>Singapore</h6>' +
              '</div>' +
            '</li>' +
            '<li data-attr="box-layout" class="box-layout">' +
              '<div class="layout-img">' +
                '<a href="javascript:void(0)">' +
                  '<img src="/static/assets/images/landing/layout-images/newyork.png" class="img-fluid" alt="">' +
                '</a>' +
                '<h6>New York</h6>' +
              '</div>' +
            '</li>' +
            ...
            '<li data-attr="material-icon">' +
              '<div class="layout-img">' +
                '<a href="javascript:void(0)">' +
                  '<img src="/static/assets/images/landing/layout-images/rome.jpg" class="img-fluid" alt="">' +
                '</a>' +
                '<h6>Rome</h6>' +
              '</div>' +
            '</li>' +
            '<li data-attr="modern-layout">' +
              '<div class="layout-img">' +
                '<a href="javascript:void(0)">' +
                  '<img src="/static/assets/images/landing/layout-images/dubai.jpg" class="img-fluid" alt="">' +
                '</a>' +
                '<h6>Seoul</h6>' +
              '</div>' +
            '</li>' +
            '<li class="only-body" data-attr="default-body">' +
              '<div class="layout-img">' +
                '<a href="javascript:void(0)">' +
                  '<img src="/static/assets/images/landing/layout-images/landon.png" class="img-fluid" alt="">' +
                '</a>' +
                '<h6>London</h6>' +
              '</div>' +
            '</li>' +
